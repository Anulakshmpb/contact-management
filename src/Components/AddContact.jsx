...
//   ----------------FORM VALIDATION IN CLASS COMPONENT

import React, { Component } from "react";
import { Navigate } from "react-router-dom";
import { Formik, Form, Field } from "formik";
import { signupValidation } from "./FormValidation"; // your schema
          ...
          >
            {({ errors }) => (
              <Form>
                ...
                <button
                  type="submit"
                  className="w-full py-3 mt-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-xl shadow-lg shadow-black/20 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 tracking-wide"
                >
                  Add
                </button>
              </Form>
